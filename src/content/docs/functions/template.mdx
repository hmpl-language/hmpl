...
| -------- | --------------------------------------------------- | ------------------ |
| params   | [HMPLRequestGetParams](/types#hmplrequestgetparams) | List of parameters |
...
| context  | HMPLRequestContext | The context of the current request sent to the HMPLInstance       |
...
:::note
Since version `3.1.0`, the only argument to the function is an object
:::
